...
from API_tests_on_GamePower_and_UI_tests_on_YouTube.logic.ui_logic.youtube_home_page import YouTubeHomePage


class HomePage(unittest.TestCase):
    def setUp(self):
        self.navigator = WebNavigator()
        self.browser_driver = self.navigator.launch_browser(__class__.browser)
